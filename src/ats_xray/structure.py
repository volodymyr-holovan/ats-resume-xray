...
from .docx_structure import extract_docx_headers_footers, find_docx_text_box_content, has_table_content
...
def analyze_structure(file_path: str) -> dict:
    ...
    DOCX keys: ``headers_footers``, ``text_box_content``, ``has_table_content``.
    """
    ...
    if suffix == ".docx":
        return {
            ...
            "has_table_content": has_table_content(file_path),
        }
