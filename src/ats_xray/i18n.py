...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "plan_refresh": {
        ...
        "uk": "Освіжіть {item} чимось свіжішим: останній датований запис із цим завершився {years} р. тому.",
        "ru": "Освежите {item} чем-то недавним: последняя датированная запись с этим закончилась {years} л. назад.",
